...
1,0,17,18,3,4,2,0,18,19,5,2,0,0,19,20,3,6,3,0,20,21,3,10,5,0,21,22,5,3,0,
0,22,23,3,12,6,0,23,24,5,3,0,0,24,25,5,1,0,0,25,26,3,14,7,0,26,27,5,0,0,
...
10,0,0,43,44,5,10,0,0,44,45,5,4,0,0,45,46,5,10,0,0,46,49,5,10,0,0,47,49,
	...
	hora() {
	    ...
	    try {
	        ...
	        case 10:
	            ...
	            this.match(VueloParser.DIGITO);
	            this.state = 44;
	            this.match(VueloParser.DOS_PUNTOS);
	            this.state = 45;
	            this.match(VueloParser.DIGITO);
	            this.state = 46;
	            this.match(VueloParser.DIGITO);
...
VueloParser.GATE_LABEL = 1;
VueloParser.GUION = 2;
VueloParser.COMA = 3;
VueloParser.DOS_PUNTOS = 4;
...
class HoraContext extends antlr4.ParserRuleContext {
	...
	DOS_PUNTOS() {
	    return this.getToken(VueloParser.DOS_PUNTOS, 0);
	};
